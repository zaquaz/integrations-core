...
setup(
    ...
    keywords='datadog agent gitlab runner check',
    ...
    package_data={b'datadog_checks.gitlab_runner': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'gitlab_runner=datadog_checks.gitlab_runner:main',
        ],
    },
)
