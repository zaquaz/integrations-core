...
setup(
    name='datadog-jenkins',
    version=version,
    description='The Jenkins check',
    long_description=long_description,
    keywords='datadog agent jenkins check',
    ...
    packages=['datadog_checks.jenkins'],
    ...
    package_data={b'datadog_checks.jenkins': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'jenkins=datadog_checks.jenkins:main',
        ],
    },
)
