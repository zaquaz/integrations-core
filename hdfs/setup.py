...
setup(
    name='datadog-hdfs',
    version=version,
    description='The HDFS check',
    long_description=long_description,
    keywords='datadog agent hdfs check',
    ...
    package_data={b'datadog_checks.hdfs': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'hdfs=datadog_checks.hdfs:main',
        ],
    },
)
