...
setup(
    ...
    version=version,
    description='The DotNetclr check',
    long_description=long_description,
    keywords='datadog agent dotnetclr check',
    ...
    package_data={b'datadog_checks.dotnetclr': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'dotnetclr=datadog_checks.dotnetclr:main',
        ],
    },
)
