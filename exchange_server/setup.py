...
setup(
    ...
    keywords='datadog agent exchange server check',
    ...
    package_data={b'datadog_checks.exchange_server': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'exchange_server=datadog_checks.exchange_server:main',
        ],
    },
)
