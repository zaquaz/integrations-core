...
setup(
    ...
    keywords='datadog agent mesos check',
    ...
    package_data={b'datadog_checks.mesos': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'mesos=datadog_checks.mesos:main',
        ],
    },
)
