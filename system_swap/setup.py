...
setup(
    ...
    url='https://github.com/DataDog/integrations-swap',
    ...
    package_data={b'datadog_checks.system_swap': ['conf.yaml.example', 'requirements.txt']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'system_swap=datadog_checks.system_swap:main',
        ],
    },
)
